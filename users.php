...
$userinfo = get_user_by_allusers('users_info',$pdo);
...
?>
                <div class="col-xl-4">
                    <div id="c_<?php echo $i; ?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php $userinfo[$i]['name']; ?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <?php
                                status_id($userinfo[$i]['status']);
                                ?>
                                <a href="page_profile.html">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('img/demo/avatars/<?php echo $userinfo[$i]['avatar']; ?>'); background-size: cover;"></span>
                                </span>
                                </a>
                                <div class="info-card-text flex-1">
                                    <?php
                                        if($_SESSION['user'] == 'admin' or $user[$i]['login'] == $_SESSION['userlogin']){
                                            echo'<a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">';
                                            echo $userinfo[$i]['name'];
                                            echo '                                            
                                    ...
                                    <span class="text-truncate text-truncate-xl"><?php echo $userinfo[$i]['work']; ?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:+13174562564" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i><?php echo $userinfo[$i]['phone']; ?></a>
                                <a href="mailto:oliver.kopyov@smartadminwebapp.com" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i><?php echo $user[$i]['login']; ?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?php echo $userinfo[$i]['address']; ?></address>
