...
?>
                <div class="col-xl-4">
                    <div id="c_<?php echo $i; ?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php $users[$i]['name']; ?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    <?php
                                        if(is_admin() or $users[$i]['email'] == $_SESSION['user']['email']){
                                    ...
                                    <span class="text-truncate text-truncate-xl"><?php echo $users[$i]['work']; ?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:+13174562564" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i><?php echo $users[$i]['phone']; ?></a>
                                <a href="mailto:oliver.kopyov@smartadminwebapp.com" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i><?php echo $users[$i]['email']; ?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?php echo $users[$i]['address']; ?></address>
