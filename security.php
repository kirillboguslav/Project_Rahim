                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" value="<?php echo $user[$id]['login']; ?>" name="email">
                                </div>

                                <!-- password -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Старый Пароль</label>
                                    <input type="password" id="simpleinput" class="form-control" name="password_old">
                                </div>

                                <!-- password confirmation-->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Новый Пароль</label>
                                    <input type="password" id="simpleinput" class="form-control" name="password_new">
                                </div>
